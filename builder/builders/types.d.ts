...
declare type Attribute = danceability | energy | valence | speechiness | acousticness | instrumentalness | liveness
...
declare type Key = key_c | key_db | key_d | key_eb | key_e | key_f | key_gb | key_g | key_ab | key_a | key_bb | key_b
